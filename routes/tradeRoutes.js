...
const { validatePhone, validateResult } = require("../middlewares/validator");

router.get("/", controller.index);

router.get("/new", isLoggedIn, controller.new);

router.post("/", isLoggedIn, validatePhone, validateResult, controller.create);
